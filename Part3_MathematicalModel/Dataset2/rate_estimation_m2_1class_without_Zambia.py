...
################# read data ---------- dataset 1
#################
df = pd.read_csv("data_m2.txt", sep=",", header=None, engine='python', names=['col' + str(x) for x in range(no_pops_all+add_info+1) ])
...
init_params = [loss_init,ess_init]       # adjusted for improved fitting
